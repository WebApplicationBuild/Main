  ...
  return (
    <div className="project-page">
      <header className="page-header" style={{ 
        ...
        <h1 className="page-title" style={{ margin: 0, fontSize: '32px', fontWeight: '700', textAlign: 'center' }}>
          프로젝트 관리 페이지
        </h1>
      ...
      <div className="project-nav-section" style={{ margin: '20px 0', padding: '15px', backgroundColor: '#f8f9fa', borderRadius: '8px' }}>
        <h3 style={{ margin: '0 0 10px 0', fontSize: '1rem', color: '#495057' }}>내 프로젝트 목록 (클릭 시 이동)</h3>
        <div className="project-nav-cards" style={{ display: 'flex', gap: '15px', overflowX: 'auto', paddingBottom: '10px' }}>
          {myProjects.map(project => {
            ...
            return (
              ...
              >
                <div style={{ fontWeight: 'bold', fontSize: '0.95rem', color: isActive ? '#0ca678' : '#343a40', marginBottom: '4px' }}>
                  {project.title}
                </div>
      ...
      {/* projectId가 있을 때만 상세 내용 표시, 없으면 안내 문구 표시 */}
      {projectId ? (
        <>
          {/* 기존 레이아웃 */}
        ...
        <div style={{ textAlign: 'center', padding: '60px 20px', backgroundColor: '#fdfdfd', borderRadius: '8px', border: '1px dashed #ced4da' }}>
          <h2 style={{ color: '#495057', fontSize: '1.2rem', margin: '0 0 10px 0' }}>위 목록에서 관리할 프로젝트를 선택해주세요 👆</h2>
          <p style={{ color: '#868e96', fontSize: '0.9rem', margin: 0 }}>프로젝트 카드를 클릭하면 상세 일정과 팀원 명단을 확인할 수 있습니다.</p>
        </div>
      )}
    </div>
  );
